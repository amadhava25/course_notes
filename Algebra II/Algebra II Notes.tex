...
\section{Basic Category Theory}
	...
	\begin{theorem}(Yoneda Lemma) There is a natural isomorphism between the functors 
		...
		\end{gather*}
		(as well as a dual one for the contravariant yoneda map)
		\end{theorem}
	\begin{proof}
		...
		\end{tikzcd}\]
		The natural transformation is determined by the choice of $\vartheta_c(\id_c)= *\in F(A)$, and any choice of $*$ defines such a natural transformation. 
