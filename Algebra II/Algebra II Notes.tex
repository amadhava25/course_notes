...
\newcommand{\Mod}[2]{\sideset{_{#1}}{_{#2}}{\mathop{\mathsf{Mod}}}}%the first parameter is the left ring action, the second is the right ring action, e.g. so R-S bimods are _R Mod _S. I think I'm messing up the macro for optional commands or smth so I have to debug that
